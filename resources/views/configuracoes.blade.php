<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Título Principal (Já adaptado) --}}
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">
                Configurações
            </h1>

            {{-- MOD 1: Container Principal --}}
                ...
                <div class="max-w-xl">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            {{-- MOD 2: Select/Dropdown --}}
                            <select id="theme" name="theme" class="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white text-gray-900 text-sm dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500">
                                {{-- Options: Já possuem dark:bg-gray-700 e dark:text-gray-100 --}}
                        ...
                        <div>
                            ...
                            <label class="inline-flex items-center mt-3 text-sm text-gray-700 dark:text-gray-300">
                                {{-- MOD 4: Checkbox Mudo --}}
                                <input id="mute" type="checkbox" class="mr-2 rounded border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:bg-gray-800">
                                Mudo
                            </label>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="inline-flex items-center text-gray-700 dark:text-gray-300">
                                {{-- MOD 5: Checkbox Efeitos Sonoros --}}
                                <input id="sound_effects" type="checkbox" checked class="mr-2 rounded border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:bg-gray-800">
                                <span class="text-sm">Efeitos sonoros</span>
                            </label>
                            <br>
                            {{-- Reduzir Animações --}}
                            <label class="inline-flex items-center text-gray-700 dark:text-gray-300">
                                {{-- MOD 6: Checkbox Reduzir Animações --}}
                                <input id="reduced_motion" type="checkbox" class="mr-2 rounded border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:bg-gray-800">
                        ...
                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center gap-3">
                                ...
                                {{-- MOD 7: Botão Restaurar Padrão --}}
                                <button id="settings-reset" type="button" class="inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors">
                                    Restaurar padrão
                                </button>
