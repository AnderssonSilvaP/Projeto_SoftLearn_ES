<x-app-layout>
    ...
    {{-- Container Principal --}}
    {{-- O fundo principal da página é definido pelo x-app-layout, mas o container interno usa bg-gray-50 dark:bg-gray-900 --}}
    <div class="flex flex-col h-[calc(100vh-65px)] bg-gray-50 dark:bg-gray-900 font-sans overflow-hidden transition-colors duration-300">
        ...
        <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm z-30 shrink-0">
            {{-- MODIFICAÇÃO 1: Fundo do Cabeçalho Secundário --}}
            <div class="flex justify-between items-center px-6 py-4 bg-gray-100 dark:bg-slate-800 text-gray-800 dark:text-white transition-colors duration-300">
                ...
                {{-- Botão Verificar Solução (Mantida a cor de destaque verde) --}}
        ...
        {{-- PAINEL DE MISSÃO                                --}}
        {{-- ========================================== --}}
        {{-- MODIFICAÇÃO 2: Fundo e Borda do Painel de Missão --}}
        ...
        <div class="flex flex-1 overflow-hidden relative">
            ...
            {{-- PALETA LATERAL UNIFICADA --}}
            {{-- MODIFICAÇÃO 3: Fundo e Borda da Sidebar --}}
            <div class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-10 overflow-y-auto shrink-0 select-none transition-colors">
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        {{-- Item: Ator --}}
                        {{-- MODIFICAÇÃO 4: Estilos do Item Arrastável --}}
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="space-y-2">
                        {{-- MODIFICAÇÃO 5: Estilos dos Botões de Conexão (Fundo e Texto) --}}
                ...
                {{-- Rodapé: Instruções --}}
                {{-- MODIFICAÇÃO 6: Fundo e Texto do Rodapé --}}
            ...
            {{-- MENUS DE CONTEXTO --}}
            {{-- MODIFICAÇÃO 8: Context Menu do Canvas --}}
            ...
            {{-- MODIFICAÇÃO 9: Custom Context Menu --}}
    ...
    {{-- ========================================== --}}
    {{-- MODIFICAÇÃO 10: ESTILOS CSS CUSTOMIZADOS --}}
    {{-- ========================================== --}}
    <style>
        /* CANVAS GRID */
        #diagram-canvas { 
        ...
        /* NODES (Mantidos os estilos existentes) */
        ...
        /* PORTS (Mantidos os estilos existentes) */
        ...
        .dark .node-actor svg { stroke: #cbd5e1; fill: #1e293b; } /* Ajustado o stroke e fill para dark mode */
        ...
        .dark .node-actor .label-text { background: rgba(30, 41, 59, 0.9); color: #e2e8f0; } /* Ajustado o fundo e cor do texto */
        ...
        .dark .node-usecase { background: #1e293b; border-color: #60a5fa; box-shadow: none; } /* Ajustado o fundo e borda */
        .node-usecase .label-text { text-align: center; font-size: 13px; font-weight: 600; line-height: 1.2; color: #1e3a8a; }
        .dark .node-usecase .label-text { color: #bfdbfe; } /* Ajustado a cor do texto */
        ...
        .dark .node-system { border-color: #94a3b8; background: rgba(15, 23, 42, 0.6); } /* Ajustado o fundo e borda */
        ...
        .dark .node-system .system-title { background: #334155; border-bottom-color: #475569; color: #e2e8f0; } /* Ajustado o fundo e cor do título */

        /* TEXT EDIT */
        [contenteditable="true"]:focus { border-bottom: 1px dashed #3b82f6; outline: none; background: rgba(255,255,255,0.8); }
        .dark [contenteditable="true"]:focus { background: rgba(30, 41, 59, 0.8); color: white; } /* Ajustado o fundo e cor do texto */
        ...
        .dark .jtk-overlay { background-color: #1e293b; border-color: #475569; color: #cbd5e1; } /* Ajustado o fundo, borda e texto */
        
        /* SCROLLBAR */
        .custom-scrollbar::-webkit-scrollbar { width: 6px; }
        .custom-scrollbar::-webkit-scrollbar-track { background: transparent; }
        .custom-scrollbar::-webkit-scrollbar-thumb { background-color: #cbd5e1; border-radius: 20px; }
        .dark .custom-scrollbar::-webkit-scrollbar-thumb { background-color: #475569; } /* Ajustado a cor da barra de rolagem */
    </style>
